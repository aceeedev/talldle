  ...
  return (
    <div onClick={hideHowToPlayCard} id="how-to-play" className="invisible fixed top-0 pt-14 sm:pt-0 sm:flex w-screen h-screen bg-[#00000050] hover:cursor-pointer z-1">
      <div onClick={(e) => e.stopPropagation()} className="relative m-auto bg-black p-8 sm:p-12 text-gray-100 max-w-2xl hover:cursor-default">
        <div tabIndex={0} onClick={hideHowToPlayCard} onKeyDown={(e) => (e.key === "Enter") && (hideHowToPlayCard())} className="absolute top-2 sm:top-4 right-2 sm:right-4 w-12 sm:w-14 rounded-full p-2 hover:cursor-pointer hover:bg-[var(--dark-accent)] focus:bg-[var(--dark-accent)]">
        ...
        <div className="text-neutral-200">
          ...
          <ul className="list-disc list-inside">
            ...
            <li><span className="text-gray-300 underline font-bold">Gray</span> = incorrect order and incorrect placement.</li>
          </ul>
          <br />
